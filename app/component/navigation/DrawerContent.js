        ...
        <View style={styles.drawerContent}>
          <View style={styles.userInfoSection}>
            <View style={{ flexDirection: "row", marginTop: 15 }}>
              <View style={{ marginLeft: 15, flexDirection: "column" }}>
                ...
                <Caption style={styles.caption}>dominykas@gmail.com</Caption>
              </View>
            </View>
          ...
          <Drawer.Section style={styles.drawerSection}>
            ...
            <DrawerItem
              ...
              label={WifiSecurity}
              onPress={() => {
                props.navigation.navigate(WifiSecurity);
              }}
            />
            <DrawerItem
              icon={() => (
              ...
              label={AppUpdates}
              onPress={() => {
                props.navigation.navigate(AppUpdates);
              }}
            />
            <DrawerItem
              icon={() => (
              ...
              onPress={() => {
                props.navigation.navigate(PermissionManager);
              }}
            />
            <DrawerItem
              icon={() => (
              ...
              label={Fishing}
              onPress={() => {
                props.navigation.navigate(Fishing);
              }}
            />
            <DrawerItem
              icon={() => (
